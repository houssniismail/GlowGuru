  ...
  <a href="#" class="flex">
    ...
    <div class="relative ">
       <div class="w-96 h-10 relative rounded-3xl ml-auto mr-auto">
             <input class="w-96 h-10 relative rounded-3xl ml-auto mr-auto" placeholder="name ..." name="value1" type="file" >
       </div>
       <br>
       <div class="w-96 h-10 relative rounded-3xl ml-auto mr-auto">
       ...
       <center>
       <button class=" bg-blue-700 w-96" style=" height: 40px; border-radius: 10px;" type="submit" name="submit">update</button>
       </center>
       <?php endforeach;?>
</form>
</body>
